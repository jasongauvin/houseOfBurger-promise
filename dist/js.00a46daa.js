...
var buttonVerre = document.querySelector('.buttonVerre');
var buttonBurger = document.querySelector('.buttonBurger');

var commanderBurger = function commanderBurger() {
...
var commanderVerre = function commanderVerre() {
...
buttonBurger.addEventListener('click', function () {
  commanderBurger().then(function (response) {
    console.log(response);
  }).catch(function (response) {
    console.log(response);
    commanderVerre().then(function (response) {
      console.log(response);
    });
  });
});
buttonVerre.addEventListener('click', function () {
